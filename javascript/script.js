...
function updateTimer() {
  const targetDate = new Date("march 8, 2025 20:50:00").getTime();
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  const phoneNumber1 = '543416289157'; // Número para el primer botón
...
document.addEventListener('DOMContentLoaded', function() {
  // Definir los números de teléfono
  const recipientNumber1 = '543416902463'; // Número para el primer botón
